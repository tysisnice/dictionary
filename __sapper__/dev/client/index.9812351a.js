import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, t as text, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, j as insert, k as append, l as noop, B as empty, o as mount_component, q as transition_in, r as transition_out, u as destroy_component, a as space, m as listen, L as update_keyed_each, G as check_outros, v as validate_store, w as component_subscribe, F as group_outros, Q as outro_and_destroy_block } from './index.efb24f45.js';
import { l as lookup } from './index.3f16ccce.js';
import { W as WordCard } from './WordCard.5e09a946.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "search-icon svelte-zvwzgj");
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(input, "class", "svelte-1idlthm");
			add_location(input, file$1, 14, 2, 412);
			attr(div0, "class", "svelte-1idlthm");
			add_location(div0, file$1, 15, 2, 479);
			attr(div1, "class", "search-bar svelte-1idlthm");
